...
def simulate_full(sim_folder, increments, f0, bw, Nf, f_samp, fold, subintlen, period, flux, psr_name,\
    ...
    # Define the ISM object
        ...
        print("9")
        pfit = pss.io.PSRFITS(path=fitspath, template=tempfits, fits_mode='copy', obs_mode='PSR')
        print("10")
...
template_Lband = "templatefiles/J0000+0000/fits_Lband_ASP0.fits.sm"
...
#May need this?
temp_Lband = "templatefiles/J00000+0000/fits_Lband_ASP0.fits.sm"
#temp_Lband = pss.pulsar.GaussProfile(peak = 0.25, width = 0.01, amp = 1.0)
#Do we need to change these Chns?
#temp_Lband.init_profiles(2048, Nchan = 4)
